...
And if you choose to follow the wikipedia trail lots more weird things, such as this guy: [https://en.wikipedia.org/wiki/Valentin\_Tomberg](https://en.wikipedia.org/wiki/Valentin_Tomberg)
...
That combination of professions is extremely sketchy. [German Wikipedia](https://de.wikipedia.org/wiki/Richard_Karutz) neglects to mention this particular bit (weird how that keeps happening):
