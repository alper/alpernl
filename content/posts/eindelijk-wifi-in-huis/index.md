...
Vandaag deze oude [FON](http://www.fon.com/) router bij mijn ouders opgehaald en geïnstalleerd [^3]. Op Cristiano's aanraden heb ik de Fon-firmware overschreven met [dd-wrt](http://www.dd-wrt.com) wat bijzonder fijn werkt [^4] en uit den treure configureerbaar lijkt.
...
[^2]: Dit waren zowel een Apache frontend webserver alswel een complete geproxyde [Zope](http://www.zope.org) installatie waar het blog onder draaide. Het feit dat Zope zo bijzonder exotisch is, zorgde ervoor dat migratie naar een standaard PHP/MySQL hosting provider niet één-twee-drie geklaard was.
