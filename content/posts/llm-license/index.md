---
date: '2026-03-23T20:09:07+01:00'
title: "LLM Driver's License"
author: "alper"
categories:
  - english
  - leadership
...
---
Here’s an idea: Developers should go through a proficiency test before they are allowed to use LLMs to generate code. Think of it as an AI driver’s license.

This is similar to how software shops would ask a certain amount of apprenticeship from junior engineers before they would get push access or review credentials on a repository. Similarly, before we allow somebody to run loose with the code generating power of an LLM, we should make sure they know how to wield it safely.

Using an LLM for learning and doing research should of course be unlimited. Just that people shouldn't spend their time trying to one-shot their assignments. That way of working is way too tempting for somebody who doesn't know better.

Both sides would benefit from this arrangement.

## Company

It's obvious that LLMs function as an amplifier. Those who are skilled, can wield them to become better and much more effective. Those who aren't, will use the tool to paper over their gaps in knowledge and effective delivery.
...
For a junior this is more or less impossible. Spending your time telling the LLM to "fix lint" until your change passes CI and then hoping somebody else will approve your code to merge, is a losing proposition.
