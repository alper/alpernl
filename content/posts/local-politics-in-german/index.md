---
_edit_last: "2"
_wp_old_slug: doctrines-in-german
_wpas_done_all: "1"
author: alper
categories:
  - english
...
To do this I'm going to attend events of the two major progressive parties around: [die Grüne](http://www.gruene.de/) (the Greens) and [die Linke](https://www.die-linke.de/) (the Left). There have been local elections last month and both parties are likely to enter in a coalition with the [SPD](https://www.spd.berlin/) and rule, so it is an exciting time to dive in.
...
The Greens were peeved that they'd suffered a loss but not super peeved. They are still [the biggest party in Friedrichshain/Kreuzberg](https://de.wikipedia.org/wiki/Bezirksverordnetenversammlung#/media/File:Allocation_of_seats_in_the_borough_council_of_Friedrichshain-Kreuzberg_(DE-2016-10-27).svg) and they will likely get to govern Berlin as a whole as well.
...
Last Saturday I finally found a Linke event that I could attend which happened to be the education session for their locally elected representatives. Each borough in Berlin is governed by a [BVV](https://de.wikipedia.org/wiki/Bezirksverordnetenversammlung) (Bezirksverordnetenversammlung) which is the lowest level of representation and the only one I am allowed to vote for in Germany ((Don't even get me started on this. European citizens get to vote for cities in Germany but Berlin is not a city but a state. The equivalent of a city in Berlin is the Bezirk (borough) but it cannot do any of the things a regular city would be able to do.)). This event was meant to give the newly elected legal and administrative foundations to help them through the next five years.

I showed up ((90% of local politics is showing up.)) this Saturday morning at 09:00 for a four hour lecture. Some thirty people, mostly newly elected Linke BVV representatives but also some stray SPD/Grüne members, were there. I wouldn't say the Linke is a more representative cross-section of Berlin but it seems somewhat more social-economically diverse.
