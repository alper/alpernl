...
Voor de lezers hier verandert er niet heel veel. Ik blijf doorschrijven op de nieuwe server op een [Wordpress](http://wordpress.org) blog onder [http://alper.nl/dingen](http://alper.nl/dingen) en de feeds die hier staan worden permanent doorverwezen naar [http:/alper.nl/dingen/feed](http:/alper.nl/dingen/feed).

Ik kan dan weer lekker gaan schrijven en een stapel hoognodige verbeteringen door gaan voeren.