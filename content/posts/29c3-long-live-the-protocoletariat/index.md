...
They treat the various levels of obscurity and disfunctionality built into [Liquid Feedback](http://liquidfeedback.org/) but on the whole they do agree that it is a functional system that needs some bug fixing.
...
1. A language for protocolization of executive processes
1. A decentralized but collectivized and compellable taxation protocol for an anonymous crypto currency
