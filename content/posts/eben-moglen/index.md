...
Everything taken into account though, BoF are our own stalwart bastion in the fight for digital freedom so I suggest [you support them](https://www.bof.nl/doe-mee/).
...
The track record of the free software movement when it comes to usability and consumer appeal over the past decades has not been stellar ((These are the people that still can't figure out how to [connect a laptop to a beamer](http://twitter.com/#!/anildash/status/26592416315) or build a workable FTP-client.)). In netbooks and other devices adoption is increasing but the frontier has been moved on to mobile devices and on to closed (but tempting) app platforms.
...
From an experience point of view this is going [to be a hell of a nut to crack](http://twitter.com/alper/status/26934224695). We already have best of breed applications that serve most of these ends ((So if a friend of mine needed a backup made, would I tell them to buy and configure some arcane plug that goes into the wall or would I tell them to signup for [Dropbox](http://www.getdropbox.com/)? Mind you Dropbox has a large and quite talented team of engineers and designers who have worked very hard to make that experience as seamless as it is.)). These are already crystallized, have tremendously talented people working for them and have massive network effects. Building functional parity services is going to take a lot of time, these are probably not going to be as interesting, usable or seductive as their proprietary counterparts and in the meantime those will have moved the goalposts.
...
My discussion with Mr. Moglen served as a reminder how immense this cultural divide is and frankly I don't think it is bridgeable in any traditional way ((These kind of discussions with free software people also quickly deteriorate into technological pissing contests. Though I may at times still be amused by those, your average user couldn't care less about the intricacies.)). It gets mired in assumptions on technology use, problems that need solving and a misunderstanding of what people (users) actually want and value in software.

So in short: freedom without usability does not amount to much. I consider myself rather well versed in these issues but I use Apple products and Facebook ((You could argue that my knowledge of these systems gives me a more informed choice, which is only partially true.)). If all the knowledge within the movement cannot deter me, then 1. imagine the general public and 2. realize that it is not an education problem we are dealing with.
...
What I meant by the wiring of public space is the fact that every object from lanterns and traffic lights to every brick and tile can and will have an internet connection (think [Everyware](http://speedbird.wordpress.com/)). Construction companies and IBM are pitching this stuff on greenfield cities and systems already ((For instance the new parking meter system in San Francisco.)). We in the old world are somewhat insulated from these developments due to sheer inertia, though we already have [near perfect parking camera surveillance](/dingen/2009/06/the-city-is-here-for-you-to-get-fined-by/).

The virtualization of public space is nearing with the linking of real life and online be it [conceptually](http://foursquare.com/) or in full blown [AR](http://www.layar.com/). Object and facial recognition, real-time image processing and filtering and differentation/personalization are going to have large scale effects. Imagine coupling this with [ad supported](http://janchipchase.com/tags/advertising/) carrier provided AR displays and things get really hairy really quickly.

I think this is going to have large scale repercussions ((I'm giving a talk on some of these developments this Thursday.)) and it would be good if the privacy movement had its eye on this ball as well (yes, there are many balls), however nascent it might seem at this moment.
