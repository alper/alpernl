...
guid: http://alper.nl/dingen/?p=2080
parent_post_id: null
post_id: "2080"
...
>
> Starts with Amsterdam party scene and scenes from the [RoXY](http://nl.wikipedia.org/wiki/Roxy). Amsterdam used to be very dynamic in the early 90s.
>
...
>
> [Freestate Amsterdam](http://www.vrijstaatamsterdam.nl/) project for the Rotterdam biennale to see about a different way to think about urban planning in the West Port of Amsterdam. It's a massive port that is mostly unknown and unloved.
>
...
>
> _Recognize the existing qualities of a place and try to add to those without detrimenting from the original experience._
>
