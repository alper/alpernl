...
**Update:** After thinking it over a bit more and reading more [misguided German business model ideas](http://digitalegesellschaft.de/2012/04/neue-finanzierungsmodelle-zwischen-copyright-und-commons/) for creative production, I think the next three requirements could be used to make a culture flat rate work:

1. **Blanket.** A culture flat rate would need to be truly blanket to solve a lot of problems. If it is not, the difference with Spotify or Netflix streaming is zero and it would seem odd to codify into law what is in fact just another business. On the other hand, if the goal is to solve the copyright problem for everybody, a flat rate scheme should ensure that I cannot be sued anymore for _any_ copyright infringement. That was after all the problem to be solved. With current international intellectual property and trade treaties this seems unlikely to happen.
1. **Voluntary.** A flat rate should be voluntary. I should not be forced to pay into a scheme I don't want to or which is of no use to me (like the [GEZ](http://www.gez.de/)). Styled this way, the flat rate would be a kind of legislative insurance for users to prevent getting sued for nonsense and the funds collected could be used to support a couple of starving artists. Though there seem to be altogether too many of those in Germany. This approach would also demonstrate actual market fit of the scheme.
1. **Cheap.** A hard requirement on any scheme would be that a flat rate needs to be cheap, cheaper even maybe than the current tv license. That is the only way to ensure incentives for creators to create new products and new business models. If the flat rate is set too high, it risks becoming a cash cow for a sick industry and further stagnate developments in an already conservative country.

Will any of those happen? Reading [the proposed business models on an upcoming event](http://digitalegesellschaft.de/2012/04/neue-finanzierungsmodelle-zwischen-copyright-und-commons/), I'm rather pessimistic.
