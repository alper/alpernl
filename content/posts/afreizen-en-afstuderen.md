...
guid: http://alper.nl/dingen/2007/09/afreizen-en-afstuderen/
parent_post_id: null
post_id: "123"
tags:
  - reizen
...
Engeland lijkt wat mij betreft erg op één van mijn minst favoriete Oost Europese landen: Polen ((Al kwam ik in Syrië wel [twee coole Polen](http://www.flickr.com/photos/alper/1292850467/in/set-72157601795954750/) tegen uit Krakow.)). Overeenkomsten:

- Mensen zijn er bovenmatig vaak dronken.
- Het lokale eten is niet te vreten.
- Dingen zien er shabby uit.

Daarnaast snap ik niet waarom in Engeland alles zo duur moet zijn. Het is toch niet zo alsof ze daar een soort hyperinflatie hebben doorgemaakt, toch? En veel krijg je er niet voor terug. In Kopenhagen zijn dingen ook veel duurder dan in Nederland, maar daar ziet ook alles er beter uit ((Het land en de mensen.)).
...
Maar in deze hoek wil ik nog wel meer zien. Ik heb nu gemerkt dat je in weinig tijd zonder al teveel stress veel kunt reizen en zien. Volgende keer drie of vier weken en dan invliegen op Trabzon, dan via Kars ((Waar het boek Sneeuw van [Orhan Pamuk](http://en.wikipedia.org/wiki/Orhan_Pamuk) zich afspeelt.)) naar Georgië, [Tblisi](http://en.wikipedia.org/wiki/Tblisi) en [de geboorteplaats van Stalin](http://en.wikipedia.org/wiki/Gori%2C_Georgia) bezoeken, dan wel of niet [Armenië](http://en.wikipedia.org/wiki/Armenia) in met mijn Nederlandse paspoort en daarna naar [Azerbaijan](http://en.wikipedia.org/wiki/Azerbaijan) om het mausoleum van [Nezami](http://en.wikipedia.org/wiki/Nezami) te bezoeken en Baku en de Kaspische zee te zien, daarna Iran in en [Tabriz](http://en.wikipedia.org/wiki/Tabriz), [Tehran](http://en.wikipedia.org/wiki/Tehran) en [Isfahan](http://en.wikipedia.org/wiki/Isfahan) zien, als het kan misschien nog naar [Ashgabat](http://en.wikipedia.org/wiki/Ashgabat) (( [Dit](http://en.wikipedia.org/wiki/Image:IndependenceMonumentAshgabat.jpg) is toch wreed!)) en terugvliegen via Dubai.
