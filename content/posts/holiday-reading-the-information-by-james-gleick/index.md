...
The book focuses on [Shannon](http://en.wikipedia.org/wiki/Claude_Shannon), where GEB for instance is more about Kurt Gödel and Cryptonomicon (the prelude to the Baroque Cycle) is more about Alan Turing. What is interesting to note is how Shannon's work contributed an informational turn to the social sciences.
