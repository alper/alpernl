...
A lot of issues about current initiatives were discussed, about various [Click-Use Licenses](http://www.opsi.gov.uk/click-use/index) and about how open data should be financed.
...
- [Comprehensive Knowledge Archive Network](http://ckan.net/package/list/6)
- [Office for Pulic Sector Information](http://www.opsi.gov.uk/)
- [What do they know](http://www.whatdotheyknow.com/)
- [Rewired State](http://rewiredstate.org/)

I think the [Hack The Government Day](http://rewiredstate.org/) that Rewired State are planning is a very good idea. It's been something of a year since we had our last govcamp in the Netherlands but I also see the need to combine the currently running initiatives into a more developer related event.
