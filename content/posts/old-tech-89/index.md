...
The first comment I got was that the dojoType in the widgets `<div dojoType="FisheyeList"…` would not validate. On page load dojo scans the dom to see where it has to replace nodes with widgets. The dojoType attribute is one of the handles it can grab hold of.
