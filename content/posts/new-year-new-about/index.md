...
> ### Early career
>
> Already being well situated in the local and European web scenes after finishing university Alper went straight into freelancing for [Aardverschuiving Media](http://aardverschuiving.com) without an intermediate period of corporate mind numbing. Trying to find a good position to innovate the web from Delft, he also opened [a coworking office](http://wiki.coworking.info/Studio+4+Stagioni) for a year that became a hub for the local freelance community —he also started Dutch coworking map [Coworker.nl](http://coworker.nl) together with [Robert Gaal](http://coworker.nl)— shortly after which he moved to the greener pastures of Amsterdam.
>
> Alper is also a founding member of Dutch finance startup [Tipit.to](http://tipit.to) a small corporation that has transformed thinking on crowdsourced micropayments and despite struggles with Paypal has financed [Wikileaks](http://wikileaks.org/) among other public initiatives.
>
> ### Thought leadership
>
...
>
> The [blog](/dingen/) Alper writes on this site is a long running mainstay of the Dutch blogosphere and it continues to be a widely respected peripatetic rumination on the intersection of design, technology and society in the broadest sense.
>
> Alper and [Robert Gaal](http://twitter.com/robertgaal)'s nose for up and coming web trends enabled them to scout the fresh startup [Foursquare](http://foursquare.com) and bring it to its first international outing in Amsterdam shortly after its 2009 [SxSWi](http://sxsw.com) launch. They both remain set to this day both on founding, finding and befriending the web's next hottest startups.
>
> Alper's newest foray is [Monster Swell](http://monsterswell.com) an agency to aid people, corporations and governments in making sense of vast quantities of data using statistical analysis, user experience design and data visualization. Never content to settle for yesterday's status quo Alper is determined to stay at the forefront of the technological wave.
>
> ### Extra curriculum
>
...
>
> Alper is also well represented on the following web properties: [Twitter](http://twitter.com/alper), [LinkedIn](http://www.linkedin.com/in/alper), [Flickr](http://www.flickr.com/photos/alper/), [Anobii](http://www.anobii.com/alper/books), [Dopplr](http://www.dopplr.com/traveller/alper/public), [last.fm](http://www.last.fm/user/illustir) and [Delicious](http://delicious.com/alper).
