...
[Adam Greenfield](https://twitter.com/agpublic) mentioned the [Institut for (X)](http://www.institutforx.dk/) in Aarhus which looks very similar in its setup and goals. In Berlin there is [the Alte Gießerei](http://gies.se/) which is being converted into a similar setup [^1]. There are [a](http://agoracollective.org/) [bunch](http://www.exrotaprint.de/) [more](http://www.baumhausberlin.de/category/blog/) [spaces](http://www.zku-berlin.org/) that do something in that direction but most of them do not manage to hit the scale or communal vibe that I try to describe above.

[^1]: It manages to hit the same concentration of disciplines, scale, workshops and it is conveniently far out of the city center in Lichtenberg.
