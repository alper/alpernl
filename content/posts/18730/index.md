...
Fixing the encoding errors was mostly a Claude assissted find and replace job over the entire body of files. And now I can be fairly sure that they won't come back because the connection to the database didn't have a magic parameter specified.
