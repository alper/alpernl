...
This week I bought [Ultratron](http://www.puppygames.net/ultratron/) and played that a bit. It looks like a solid 2D shooter like I haven't played in ages. Before that I played bunches of [Ridiculous Fishing](http://www.ridiculousfishing.com/) and Spelunky which Darius Kazemi has kindly [translated into HTML5](http://tinysubversions.com/2012/07/spelunky-html5/) for us non-Windows users. And that's only this week. I'm playing so many games right now. The amount of new games being released is also huge. Truly we live in [a ludic age](http://ericzimmerman.com/).

How different this is from back in the day when I would spend days grinding levels and gold in Final Fantasy on the NES or map out the dungeons of [Faria](http://en.wikipedia.org/wiki/Faria:_A_World_of_Mystery_and_Danger). There simply wasn't that much to play back then so we made do with what we had. I hear there are [still people with such singular dedication to a game](http://www.wowaholics.org/), but I can't imagine it.
