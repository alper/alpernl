...
Technologically I have quite some issues with the implementation which is brilliant at places and patchwork on others [^2], but those are mostly besides. It works and it does what it needs to do. The main Pirate Party implementation lives here: [https://lqfb.piratenpartei.de/](https://lqfb.piratenpartei.de/) and is publicly browsable. A cursory glance reveals a lot of interesting things.
