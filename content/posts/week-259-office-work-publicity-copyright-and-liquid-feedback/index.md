...
Also the news that I will be speaking at NEXT Berlin on a topic near to my heart [“Love in Times of Gamification”](http://nextberlin.eu/topic/love-in-times-of-gamification-dont-play-games-with-my-heart/). Not only is that turning out to become a huge and important subtopic within gaming, it is also going to be a lot of fun. The Dutch newspaper NRC featured an article ( [link for subscribers](http://digitaleeditie.nrc.nl/NH/2012/1/20120227___/2_32/index.html#page32)) about [the Social Cities of Tomorrow](http://www.socialcitiesoftomorrow.nl/) conference in which I am also quoted talking about [Hack de Overheid](http://hackdeoverheid.nl) and [Apps for Amsterdam](http://appsforamsterdam.nl).
...
Technologically I have quite some issues with the implementation which is brilliant at places and patchwork on others ((Back button breaking javascript on the site, a backend patched together using PL/pgSQL and a CMS in Lua.)), but those are mostly besides. It works and it does what it needs to do. The main Pirate Party implementation lives here: [https://lqfb.piratenpartei.de/](https://lqfb.piratenpartei.de/) and is publicly browsable. A cursory glance reveals a lot of interesting things.
...
More worrisome are the non-digital points of view proposed on the platform. Besides a [proposal for Open Government Data](https://lqpp.de/be/initiative/show/146.html) being approved ((Demanding the horrible horrible RDF which we could do without.)) there are also proposals for [a base income for everybody](https://lqpp.de/be/initiative/show/1270.html) and many other wish-list utopian social measures. None of those seem to be predicated on fiscal solvency. Many of the measures rely on more government to improve society. That is oddly reminiscent of the modeling paradox: **a better model does not guarantee better outcomes.** The same with government, the current government here is not very small but already rather dysfunctional.
