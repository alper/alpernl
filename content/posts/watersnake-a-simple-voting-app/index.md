...
[^1]: Among others: the atrocious user experience, the fact that it does not support anonymity, the impossibility of i18n.
[^2]: The core is a 4500 line pgsql file which is a solid way to deter outside involvement in a project.
[^3]: I for instance can't really imagine using sqlalchemy over the django ORM.
[^4]: We can build it out to support as complex a voting setup and algorithms as you would like, but I would be reluctant to do so without clear indications that it will be actually beneficial.
