...
In the Turkish rooms I would hear words that I didn't know every other sentence, sometimes entire concepts like _kadının beyanı esastır_. Finally, I had a situation where I was exposed to a high level of Turkish and I had the motivation to improve this.

I started noting these words down in Anki, which I had bought previously to study the [HSK](https://en.wikipedia.org/wiki/Hanyu_Shuiping_Kaoshi). Adding a word to my deck here and there was slow: switch to [dictionary](http://tureng.com/) (now I use [the official one](https://sozluk.gov.tr/)), switch to Anki and write the card, switch back.

For some extra speed, I dug up a master word list I had made more than a decade ago. Back then I had read most of Orhan Pamuk's then bibliography ( [Yeni Hayat](https://www.goodreads.com/book/show/668194.Yeni_Hayat?from_search=true&from_srp=true&qid=K0RO1ChOcN&rank=1), [Sessiz Ev](https://www.goodreads.com/book/show/270872.Sessiz_Ev?from_search=true&from_srp=true&qid=1u0LNGhFQh&rank=1), [Kara Kitap](https://www.goodreads.com/book/show/1269960.Kara_Kitap?from_search=true&from_srp=true&qid=O8K8jYjW22&rank=1), [Kar](https://www.goodreads.com/book/show/1933651.Kar?from_search=true&from_srp=true&qid=nfZYhs4caE&rank=5), [Benim Adım Kırmızı](https://www.goodreads.com/book/show/53878.Benim_Ad_m_K_rm_z_?from_search=true&from_srp=true&qid=buBTn59lmc&rank=1)) and then too found lots of words I didn't know. I passed over them and wrote them down on a piece of paper. I transcribed these papers into a list and looked up some of the meanings. But this being before [Anki](https://ankiweb.net/decks/), I had no real way to systematically learn these words and get better at Turkish. If I had, I would have improved steadily with each book I read and everything would have been great.

I went through this old word list letter by letter and over the course of a month made cards for all of the words in that list. The result of that effort is [the 1000-word deck](https://ankiweb.net/shared/info/1269846772) I have made available online now.

And now, after months of revising daily (life during the pandemic has been very exciting, why do you ask?) and also continuing to add words as I go—the recent events in Afghanistan made me add the half-Arab half-Farsi ridiculous Turkish word for _[charge d'affaires](https://tr.wikipedia.org/wiki/Maslahatg%C3%BCzar)_—I finally am out of "New" words. From now on it will just be polishing the lexicography of the deck, adding a word here and there and continuing to revise.
...
I've also been amazed by how overloaded the language is for certain concepts like disaster ( _afet_, _badire_, _facia_, _buhran_), sorrow ( _ıstırap_, _üzüntü_, _matem_, _yas_, _kahır_, _hicran_, _gam_, _tasa_, _keder_, _nedamet_, _teessür_) and many others. Also all of those words are Arabic in origin except if I had to guess by [word shape](https://en.wikipedia.org/wiki/Vowel_harmony#Turkish): _üzüntü_ (I guessed right!).

## White Turks

Delving into this part of the language and the people who use it, I came across the concept of [White Turks](https://en.wikipedia.org/wiki/White_Turks). The division between white and black Turks underlies a lot of the dynamics of the Turkey of the past decades.
