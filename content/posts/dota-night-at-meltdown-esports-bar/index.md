...
What strikes me when I go to these get togethers is that however different the people are, there is a shared culture because everybody reads [/r/dota2](http://reddit.com/r/dota2) and watches the same streams and tournaments. It is fairly homogenized everywhere with the exception of China which is insular with its own client, servers and a slew of native language media.
